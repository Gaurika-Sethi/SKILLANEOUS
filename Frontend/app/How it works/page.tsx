  ...
  const steps = [
    {
      ...
      description: "Add your resume, CV, or connect your LinkedIn profile to begin the process.",
      icon: Upload,
      color: "text-cyan-400",
    ...
    },
    {
      ...
      description: "Our AI identifies skills gaps and projects that accelerate your career growth.",
      icon: Cpu,
  ...
  const features = [
    {
      ...
      description: "Every roadmap is custom-built for your unique goals and background, not a template.",
      icon: Target,
      color: "text-cyan-400"
    },
    {
      title: "Focused on building",
      description: "Learn by doing with hands-on projects, moving beyond passive video courses.",
      icon: Zap,
      color: "text-purple-400"
    },
    {
      title: "Designed for real careers",
      description: "Build a portfolio that demonstrates the practical skills employers actually value.",
      icon: Briefcase,
      color: "text-pink-400"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-5xl font-bold text-white tracking-tight">
              How <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400">It Works</span>
            </h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              Three simple steps to transform your career trajectory using our intelligent AI analysis.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            <div className="max-w-xl">
              <h2 className="text-3xl font-bold text-white mb-4">
                Why <span className="italic font-serif text-purple-400">This</span> Works
              </h2>
              <p className="text-gray-500">
                We bridge the gap between theoretical knowledge and industry requirements by focusing on high-impact learning paths.
              </p>
            </div>
            <div className="hidden md:block h-[1px] flex-grow bg-gradient-to-r from-transparent via-white/10 to-transparent mx-10 mb-4" />
          </div>
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                    <FeatureIcon className={`${feature.color}`} size={28} />
                  </div>
