...
export default function RoadmapsPage() {
  ...
  const roadmaps = [
    ...
    { level: "Beginner", title: "Frontend Mastery", desc: "Build modern, responsive UIs with React and design systems", tags: ['React', 'Next.js', 'Tailwind'], duration: "4 months", students: "4,156", color: "cyan", role: "Frontend Developer" },
